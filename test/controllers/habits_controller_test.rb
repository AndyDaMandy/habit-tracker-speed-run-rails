...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference("Habit.count") do
      post habits_url, params: { habit: { name: @habit.name, note: @habit.note, user_id: @habit.user_id } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { name: @habit.name, note: @habit.note, user_id: @habit.user_id } }
